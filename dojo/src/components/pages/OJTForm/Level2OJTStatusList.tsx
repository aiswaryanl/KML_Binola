...
//                 {selectedView === "OJT" ? "OJT Level 2 Status" : "TenCycle Status"}
//               </h1>
//             </div>
...
//             >
//               <option value="OJT">OJT Level 2 Status</option>
...
// ✅ Demo data
const demoData: OJTStatus[] = [
  {
    id: 1,
    traineeId: "T001",
    trainee_name: "Arun Kumar",
    trainer_name: "Suresh",
    production_or_quality: "Production",
    line: "Line A",
    station: "Station 1",
    daysCompleted: 10,
    score: 85,
  ...
  },
  {
    id: 2,
    traineeId: "T002",
    trainee_name: "Meena R",
    trainer_name: "Ravi",
    production_or_quality: "Quality",
    line: "Line B",
    station: "Station 3",
    daysCompleted: 6,
    score: 55,
...
const Level2OJTStatusList: React.FC = () => {
  const [data] = useState<OJTStatus[]>(demoData);
  const [searchTerm, setSearchTerm] = useState("");
  const [statusFilter, setStatusFilter] = useState("All");
  const [categoryFilter, setCategoryFilter] = useState<
    "All" | "Production" | "Quality"
