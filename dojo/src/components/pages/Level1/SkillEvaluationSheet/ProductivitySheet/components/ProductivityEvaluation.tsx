...
interface ProductivityEvaluationProps {
  module: Module;
...
const ProductivityEvaluation: React.FC<ProductivityEvaluationProps> = ({
  module,
  onUpdateModule,
  onUpdateSequence,
  onAddSequence,
  ...
  console.log('ProductivityEvaluation render:', { 
    currentEvaluationRound, 
    enableE1, 
    enableE2, 
    enableE3,
        ...
        {methodSequences.map((sequence, index) => {
          ...
          return (
            <div key={sequence.id} style={{ display: 'grid', gridTemplateColumns: '120px 2fr 1fr 1fr 1fr 1fr' }} className="border-b border-gray-300 hover:bg-blue-50 transition-colors">
              ...
              {/* Sequence Column - Editable with remove button */}
        ...
        {/* <div className="p-4 bg-gradient-to-r from-blue-50 to-blue-100 border-b-2 border-gray-200">
          <div className="text-center">
            <button
              ...
              className="flex items-center justify-center space-x-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-lg hover:shadow-lg transition-all duration-200 shadow-md transform hover:-translate-y-1 mx-auto"
            >
...
export default ProductivityEvaluation;
