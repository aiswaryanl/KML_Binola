...
export const tiles = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'Quiz Results', path: '/quiz-results', icon: ClipboardPenLine  },
    ],
    icon: Sword,
    statusText: 'Active',
  ...
  },
  {
    ...
    links: [
      { name: '10 Cycle', path: '', icon: ClipboardCheck },
  ...
  },
  {
    title: 'Exam Tool',
    links: [
      { name: 'Exam Tool Download', path: '/DownloadFiles', icon: DownloadCloud },
    ],
    icon: Award,
    statusText: 'Updated',
